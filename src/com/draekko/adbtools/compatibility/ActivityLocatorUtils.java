 ...
 */
package com.draekko.adbtools.compatibility;
...
public class ActivityLocatorUtils {
    public static boolean shouldUseMergedManifest(@NotNull AndroidFacet facet) {
        //return facet.is.isGradleProject() || facet.getProperties().ENABLE_MANIFEST_MERGING;
        return facet.getProperties().ENABLE_MANIFEST_MERGING;
    }
